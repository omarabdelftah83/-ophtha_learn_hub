...
import '../../pages/main_page/home_page/note_page/notes_page.dart';
                              ...
                              child: Stack(
                                ...
                                children: [
                                  ...
                                  ? Container(
                                      ...
                                      child: Image.asset(AppAssets.appLogoPng,width: 65,height: 65,fit: BoxFit.fill,)
                    ...
                    child: SingleChildScrollView(
                      ...
                      child: Column(
                        children: [
                          ...
                          menuItem(appText.addANote, AppAssets.documentSvg, (){
                            if(hasAccess(canRedirect: true)){
                              nextRoute(NotesPage.pageName);
                            }
                          }),
                          ...
                          Row(
                            children: [
                              GestureDetector(
                                onTap: ()async{
                                  await launchUrl(
                                      Uri.parse("https://www.facebook.com/profile.php?id=61550514410726&mibextid=ZbWKwL"));
                                },
                                child: FaIcon(
                              ...
                              GestureDetector(
                                onTap: ()async{
                                  await launchUrl(
                                      Uri.parse("https://wa.me/201559234577"));
                                },
                                child: FaIcon(
