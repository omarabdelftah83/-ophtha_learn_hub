...
import 'app/pages/introduction_page/emulator_check_page.dart';
import 'app/pages/introduction_page/language_page.dart';
import 'app/pages/introduction_page/vedio_page.dart';
...
import 'app/pages/main_page/home_page/freecourse_page/free_course_page.dart';
import 'app/pages/main_page/home_page/meetings_page/meetings_page.dart';
import 'app/pages/main_page/home_page/note_page/notes_page.dart';
    ...
    return MultiProvider(
      ...
      child: MaterialApp(
        ...
        routes: {
          ...
          NotesPage.pageName : (context) =>   NotesPage(),
          SplashPage.pageName : (context) => const SplashPage(),
          LanguageSelectionPage.pageName : (context) => LanguageSelectionPage(),
          EmulatorCheckPage.pageName : (context) => const EmulatorCheckPage(),
          ...
          VideoPage.pageName: (context) => const VideoPage(),
